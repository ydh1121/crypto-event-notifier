...
def main() -> None:
    ...
    checks = {
        ...
        "build59_distinct_source_grouping": "grouped[source_key].append(candidate)" in priority and '"source_group_case_count"' in priority,
        ...
        "build59_sibling_source_attempt_recovery": "_attempted_source_keys" in priority and "p.selected_primary=1" in priority and '"source_attempted_via_sibling"' in priority and '"sibling_source_attempts_recovered": True' in priority,
        ...
        "build59_selected_primary_preserved": "p.selected_primary=1" in runner and "p.selected_primary=1" in priority,
