...
def main() -> None:
    ...
    checks = {
        ...
        "integrity_backlog_v37": all(token in backlog for token in ("evaluateProfileIntegrity", "identity_mismatch", "coin_profile_cache", "balanced")),
        "supervisor_uses_v37_backlog": "coin-profile-backlog-v37" in cycle,
        "integrity_audit_command": "coin-profile-integrity-audit" in audit_client,
