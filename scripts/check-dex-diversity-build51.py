...
def main() -> None:
    ...
    checks = {
        ...
        "build51_fresh_unresearched_before_retry": (
            "PROGRESS_FRESH_UNRESEARCHED = 0" in diversity
            and "fresh_unresearched_before_retry" in diversity
            and "retryable_existing_status" in diversity
        ),
