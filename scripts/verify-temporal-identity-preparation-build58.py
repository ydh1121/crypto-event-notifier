...
from b3_trader.temporal_identity_preparation import (  # noqa: E402
    DEFAULT_MAX_CASES_PER_RUN,
    MAX_CASES_PER_RUN,
    TemporalIdentityPreparationRunner,
)
...
def main() -> None:
    ...
    if args.import_check:
        print("TEMPORAL_IDENTITY_PREPARATION_BUILD58_IMPORT=PASS")
        return
    ...
    print("=== TEMPORAL IDENTITY PREPARATION BUILD 58 RUNTIME ===")
    ...
    if not safe:
        raise SystemExit("TEMPORAL_IDENTITY_PREPARATION_BUILD58_RUNTIME=FAIL")
    print("TEMPORAL_IDENTITY_PREPARATION_BUILD58_RUNTIME=PASS")
