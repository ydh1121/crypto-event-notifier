...
from b3_trader.dex_temporal_backfill import (  # noqa: E402
    DEFAULT_MAX_CASES_PER_RUN,
    MAX_CASES_PER_RUN,
    DexTemporalBackfillRunner,
)
...
def main() -> None:
    ...
    if args.import_check:
        print("DEX_TEMPORAL_BACKFILL_BUILD56_IMPORT=PASS")
        return
    ...
    print("=== DEX TEMPORAL BACKFILL BUILD 56 RUNTIME ===")
    ...
    if not safe:
        raise SystemExit("DEX_TEMPORAL_BACKFILL_BUILD56_RUNTIME=FAIL")
    print("DEX_TEMPORAL_BACKFILL_BUILD56_RUNTIME=PASS")
