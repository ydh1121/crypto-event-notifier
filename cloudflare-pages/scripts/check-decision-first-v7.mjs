...
check('main cache is refreshed for current build',index.includes('/modules/main.js?v=95'));
...
check('current price is promoted ahead of evidence',interaction.includes('grid-template-areas:"price conclusion vitals"')&&interaction.includes('.decision-first-hero .price-stack b'));
