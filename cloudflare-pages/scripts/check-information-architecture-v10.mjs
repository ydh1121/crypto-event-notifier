...
check('architecture document fixes one vertical document scroll',doc.includes('One vertical document scroll'));
...
check('canonical layer declares one vertical document scroll',interaction.includes('One vertical scroll belongs to the document'));
check('canonical layer neutralizes internal vertical scrolling',interaction.includes('max-height:none!important')&&interaction.includes('overflow-y:visible!important'));
check('viewport layer no longer imposes dvh rail budgets',!viewport.includes('--viewport-rail-max')&&!viewport.includes('--viewport-rail-compact')&&!viewport.includes('max-height:min('));
