...
check('selected coin identity exposes ticker current price and 24h change',research.includes('market-quote-identity')&&research.includes('market-current-price')&&research.includes('data-research-live="market-change"')&&research.includes('24h'));
check('market quote dominates before decision evidence',interaction.includes('grid-template-areas:"price conclusion vitals"')&&interaction.includes('font-size:clamp(36px,3.2vw,48px)!important'));
check('market list shows ticker price and 24h change',research.includes('market-list-columns')&&research.includes('market-price-cell')&&research.includes('market-change-cell'));
check('paper performance is not presented as market change',research.includes('PAPER 수익률')&&!research.includes('data-research-live="return"'));
...
check('no new global override stylesheet was added',!index.includes('v10.css')&&!index.includes('information-architecture-v10.css')&&!index.includes('market-workspace-v11.css'));
