...
check('v5 stylesheet loaded after v4 decision workspace',index.includes('information-architecture-v5.css')&&index.indexOf('decision-workspace-v4.css')<index.indexOf('information-architecture-v5.css'));
...
check('external-event reaction is not fabricated',market.includes('대외 이벤트 반응')&&market.includes('실제 데이터 계약과 계산기가 준비된 뒤'));
...
check('v5 dark mode has explicit coverage',css.includes('html[data-theme="dark"] .journey-nav')&&css.includes('html[data-theme="dark"] .v5-lens-status'));
