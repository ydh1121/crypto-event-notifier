...
const checks=[
 ['current Viewer build preserves holdings-write lineage',/crypto-viewer-build" content="2026\.09\.21-v6\.5\.0-simplified-trading-v22"/.test(index)&&main.includes("installHoldingsWriteV16({store,root})")],
 ...
 ['existing buy fee is visible',ui.includes('기존 매수 수수료(추정)')&&ui.includes('originalBuyFee=feeReady?tradingFee(startCost,exchange,market):0')],
 ['additional buy fee is separate',ui.includes('추가매수 수수료')&&ui.includes('additionalBuyFee=feeReady?tradingFee(addition,exchange,market):0')],
