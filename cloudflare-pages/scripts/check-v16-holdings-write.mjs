...
const checks=[
 ['current Viewer build preserves holdings-write lineage',/crypto-viewer-build" content="2026\.09\.21-v6\.4\.2-v18-ui-foundation"/.test(index)&&main.includes("installHoldingsWriteV16({store,root})")],
