...
const checks=[
 ...
 ['idempotency queue',migration.includes('idempotency_key TEXT NOT NULL UNIQUE')&&service.includes('idempotency_key')],
 ['optimistic revision',migration.includes('expected_revision REAL NOT NULL')&&consumer.includes('REVISION_CONFLICT')],
 ...
 ['current exchange preserved',consumer.includes('EXCHANGE_CONFLICT')],
