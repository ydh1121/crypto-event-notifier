...
check('viewport handoff css is refreshed and loads last',index.includes('/modules/styles/viewport-first-v9.css?v=3')&&index.indexOf('interaction-layout-v4.css')<index.indexOf('viewport-first-v9.css'));
...
check('viewport layer does not disable canonical master rail scroll',css.includes('Do not override canonical master-rail scrolling here')&&!css.includes('.research-master .master-list')&&!css.includes('.asset-holdings-list'));
check('canonical layer provides bounded master rails',interaction.includes('max-height:calc(100dvh - var(--shell-header-offset,112px) - 32px)!important')&&interaction.includes('overflow-y:auto!important'));
