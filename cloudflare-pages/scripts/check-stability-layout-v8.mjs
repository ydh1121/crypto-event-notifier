...
check('canonical interaction layer remains versioned and after decision-first',index.includes('/modules/styles/interaction-layout-v4.css?v=')&&index.indexOf('decision-first-v7.css')<index.indexOf('interaction-layout-v4.css'));
