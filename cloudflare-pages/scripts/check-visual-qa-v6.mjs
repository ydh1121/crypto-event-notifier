...
check('main entry cache is refreshed',index.includes('/modules/main.js?v=92'));
...
check('desktop result panes use normal page scroll',css.includes('#pageRoot[data-page-route="research"] .research-detail')&&css.includes('#pageRoot[data-page-route="assets"] .asset-detail')&&css.includes('#pageRoot[data-page-route="paper"] .paper-detail')&&css.includes('max-height:none!important')&&css.includes('overflow:visible!important'));
check('desktop master panes remain sticky',css.includes('#pageRoot[data-page-route="research"] .research-master')&&css.includes('#pageRoot[data-page-route="assets"] .asset-master')&&css.includes('#pageRoot[data-page-route="paper"] .paper-master')&&css.includes('position:sticky!important'));
