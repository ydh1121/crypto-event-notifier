...
export function journalRecords(state){const value=fullPublic(state).journal_records||{};return{decision_changes:Array.isArray(value.decision_changes)?value.decision_changes:[],system_events:Array.isArray(value.system_events)?value.system_events:[],updated_at:n(value.updated_at)}}
