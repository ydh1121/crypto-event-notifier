...
DEFAULT_INTELLIGENCE_SOURCES: tuple[IntelligenceSource, ...] = (
    IntelligenceSource(
        ...
        notes="Official BLS calendar feed. Adapter must preserve the scheduled release time and source timezone.",
    ),
    IntelligenceSource(
        ...
        market_scope=("GLOBAL", "CRYPTO"),
        notes="Official schedule reference. Collection stays disabled until a bounded adapter is implemented and tested.",
    ),
    IntelligenceSource(
        ...
        notes="Official FOMC calendar. Meeting date, statement time, minutes time and projection releases remain distinct events.",
    ),
    IntelligenceSource(
        ...
        notes="Official index reference only. No scraper or price feed is enabled by this registry entry.",
    ),
    IntelligenceSource(
        source_id="us_sp500",
        ...
        event_types=("SP500",),
        market_scope=("US_EQUITY", "CRYPTO"),
        notes="Official index reference only. A future market-data adapter must document licensing and timestamp semantics.",
    ),
    IntelligenceSource(
        ...
        event_types=("VIX",),
        market_scope=("US_EQUITY", "CRYPTO"),
        notes="Official volatility-index reference. Delayed/reference data must not be presented as real-time without a licensed feed.",
    ),
    IntelligenceSource(
        ...
        notes="Official regulatory-news reference. Article-level adapter and entity mapping are separate work.",
    ),
    IntelligenceSource(
        ...
        market_scope=("US_REGULATION", "CRYPTO"),
        notes="Official derivatives/digital-commodity regulatory-news reference. Collection is fail-closed until adapter tests exist.",
    ),
)
