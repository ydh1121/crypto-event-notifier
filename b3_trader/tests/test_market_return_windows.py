...
from b3_trader.market_return_windows import DAY_SECONDS, prior_daily_returns
...
def test_market_feature_store_reuses_existing_market_memory_table() -> None:
    ...
    anchor = 10 * DAY_SECONDS
    for day, price in [(6, 50.0), (5, 60.0), (4, 66.0), (3, 60.0), (2, 80.0), (1, 100.0)]:
        conn.execute(
    ...
    result = MarketFeatureStore(conn).prior_day_returns(
        exchange="bithumb",
        market="KRW-AAA",
        strategy="adaptive",
        as_of_ts=anchor,
