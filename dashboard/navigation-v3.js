(function(){
  ...
  function loadResearchUi(){
    if(!document.querySelector('link[data-demo-research]')){const link=document.createElement('link');link.rel='stylesheet';link.href='./demo-research.css?v=1';link.dataset.demoResearch='1';document.head.appendChild(link)}
    if(!window.__demoResearchLoading&&!window.__demoResearchLoaded){window.__demoResearchLoading=true;const script=document.createElement('script');script.src='./demo-research.js?v=1';script.onload=()=>{window.__demoResearchLoading=false};script.onerror=()=>{window.__demoResearchLoading=false};document.body.appendChild(script)}
  }
